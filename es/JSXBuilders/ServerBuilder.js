...
ServerBuilder = __decorate([injectable(), __param(0, inject(RETAX_CONFIG_STORE)), __param(1, inject(RETAX_PROVIDER_COMPONENT)), __param(2, inject(REDUX_FACADE)), __param(3, inject(REACT_ROUTER_FACADE)), __metadata('design:paramtypes', [Object, Object, Object, Object])], ServerBuilder);
