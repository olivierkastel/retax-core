...
describe('InversifyKernelFacade', function () {
    ...
    var module1 = new _inversify.KernelModule(function (bind) {
        return bind(module1Id).toConstantValue(1);
    });
    var module2 = new _inversify.KernelModule(function (bind) {
    ...
    it('loads modules into the kernel', function () {
        ...
        var module3 = new _inversify.KernelModule(function (bind) {
    ...
    it('get all services with a same id', function () {
        ...
        var myModule = new _inversify.KernelModule(function (bind) {
    ...
    it('loads raw kernel module into the kernel', function () {
        var kernelFacade = new _InversifyKernelFacade2.default();
        var moduleId = Symbol('module');
        var modules = [new _inversify.KernelModule(function (bind) {
