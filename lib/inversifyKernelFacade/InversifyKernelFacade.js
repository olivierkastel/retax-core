...
var InversifyKernelFacade = function () {
    function InversifyKernelFacade() {
        ...
        this._kernel = new _inversify.Kernel();
...
InversifyKernelFacade = __decorate([(0, _inversify.injectable)(), __metadata('design:paramtypes', [])], InversifyKernelFacade);
exports.default = InversifyKernelFacade;
