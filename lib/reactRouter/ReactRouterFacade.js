    ...
    _createClass(ReactRouterFacade, [{
        ...
        value: function _match(config) {
            return new Promise(function (resolve, reject) {
                (0, _reactRouter.match)(config, function (err, redirectLocation, renderProps) {
                    if (err) reject(err);
                    resolve({
...
ReactRouterFacade = __decorate([(0, _inversify.injectable)(), __param(0, (0, _inversify.inject)(_inversify2.CONTEXT)), __param(1, (0, _inversify.inject)(_inversify2.REDUX_FACADE)), __param(2, (0, _inversify.inject)(_inversify2.RETAX_CONFIG_STORE)), __metadata('design:paramtypes', [Object, Object, Object])], ReactRouterFacade);
exports.default = ReactRouterFacade;
