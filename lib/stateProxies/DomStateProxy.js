...
var DomStateProxy = function (_AStateConverter) {
    ...
    _createClass(DomStateProxy, [{
        ...
        value: function read() {
            ...
            var serverState = window[_constants.INITIAL_STATE_KEY];
...
DomStateProxy = __decorate([(0, _inversify.injectable)(), __param(0, (0, _inversify.inject)(_identifiers.RETAX_CONFIG_STORE)), __metadata('design:paramtypes', [Object])], DomStateProxy);
exports.default = DomStateProxy;
