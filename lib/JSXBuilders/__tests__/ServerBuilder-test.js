...
var _ServerBuilder2 = _interopRequireDefault(_ServerBuilder);
...
_reactRouter.RouterContext.propTypes = undefined;
...
describe('ServerBuilder', function () {
    ...
    it('build and render the app', function () {
        ...
        var builder = new _ServerBuilder2.default(configStore, _RetaxProvider2.default, reduxFacade, routerFacade);
